...
function main() {
  ...
  addReleaseGate(issues, warnings, serviceGuard.serviceBinaryStatus === "implemented", "Windows Service guard executable is not implemented yet.");
