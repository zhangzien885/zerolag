...
function main() {
  ...
  ["check", "ci", "icon:generate", "pack:dir", "package:smoke", "package:verify", "installer:smoke", "installer:verify", "release:artifacts", "release:report", "release:verify", "release:build", "dist:win", "production:check", "server:check", "server:smoke", "server:test", "integrity:verify", "update:sign", "update:smoke"].forEach((scriptName) => {
