...
- Supports account binding foundations for WeChat, QQ, email, and phone accounts, with memberships linked to the signed-in account, paused when the account is signed out, and usable on another computer after signing in again.
