...
`release:inputs -- --verify-server-env --server-env .\.secrets\server.env` checks that the private payment env matches the formal input file without printing secret values.
