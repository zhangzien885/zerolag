...
- Run `npm run ui:payment:smoke` to verify the purchase dialog checkout handoff, activation-code paste normalization, official purchase fallback, order/provider display, paid refresh path, and no-demo-code guardrails.
