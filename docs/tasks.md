...
- Implement the Windows Service guard executable as the primary runtime tuning cleanup layer. Service manifest, install/uninstall scripts, packaging resources, and smoke checks are in place.
