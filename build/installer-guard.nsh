...
!macro customUnInstall
  !ifdef ZEROLAG_ENABLE_GUARD_REGISTRATION
    DetailPrint "ZeroLag: restoring runtime state and removing guard entries."
    ExecWait '"$SYSDIR\WindowsPowerShell\v1.0\powershell.exe" -NoProfile -ExecutionPolicy Bypass -File "$INSTDIR\resources\service-guard\uninstall-runtime-cleanup.ps1" -ServiceBinary "$INSTDIR\ZeroLag.exe" -CleanupOnce' $0
  !endif
!macroend
